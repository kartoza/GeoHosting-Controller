...
# Create the folders
if not os.path.exists('/home/web/media'):
    os.mkdir('/home/web/media')
if not os.path.exists('/home/web/static'):
    os.mkdir('/home/web/static')
...
#########################################################
# 6. Initiate activity types
#########################################################

print("-----------------------------------------------------")
print("6. Initiate activity types")
